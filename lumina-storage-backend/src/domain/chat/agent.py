...
from src.shared.vector_service import VectorService
from src.domain.chat.skill_service import SkillContext, SkillService
...
async def rag_search(query: str, top_k: int = 5, config: RunnableConfig = None) -> str:
    ...
    from src.domain.chat.retrieval_service import RetrievalService
