...
from src.domain.generator.generator_docx import (
...
from src.domain.generator.generator_service import GeneratorService
...
from src.domain.generator.generator_html import (
    _apply_block_ops,
    _build_diff_html,
    _html_blocks,
    _html_to_docx_bytes,
...
async def generate_from_session(
    ...
    svc = GeneratorService(db)
    session = await svc.generate_from_session(session_id, body, current_user.id)
    return GeneratorSessionResponse.model_validate(session)
...
async def document_to_template(
    ...
    from src.domain.generator.generator_template_service import commit_template, extract_template_draft
